...
func (*UnimplementedDistributorServiceServer) Delete(context.Context, *DeleteDistributorRequest) (*emptypb.Empty, error) {
...
func (*UnimplementedDistributorServiceServer) DeletePark(context.Context, *DeleteParkRequest) (*emptypb.Empty, error) {
